require 'maze_runner/algorithms/recursive_backtracker'

# MazeBuilder is a class used to build mazes
#
# Each cell in the maze is a bitfield. The bits that are set indicate which
# passages exist leading AWAY from this cell.
class MazeBuilder
  N  = 0x01 # North
  S  = 0x02 # South
  E  = 0x04 # East
  ...
  #                adhering to the interface described by MazeRunner::Algorithms::Base.
  #                It defaults to MazeRunner::Algorithms::RecursiveBacktracker.
  ...
  # Creates a new MazeRunner::Path object based on this maze instance. This can
  ...
  #
  # [:type] This defaults to +:backtracker+ (for
  # the MazeRunner::Solvers::Backtracker solver),
  # but may also be set to +:astar+ (for the
  # MazeRunner::Solvers::Astar solver).
  ...
  # MazeRunner::Solvers::Base#solve or MazeRunner::Solvers::Base#step to
  ...
  # Since #entrance may be external to the maze, #start returns the cell
  # adjacent to #entrance that lies within the maze. If #entrance is
  # already internal to the maze, this method returns #entrance.
  # If #entrance is _not_ adjacent to any internal cell, this method
  # returns +nil+.
  def start
    adjacent_point(@entrance)
  end

  # Since #exit may be external to the maze, #finish returns the cell
  # adjacent to #exit that lies within the maze. If #exit
  # is already internal to the # maze, this method returns #exit.
  # If #exit is _not_ adjacent to any internal cell, this method
  # returns +nil+.
  def finish
    adjacent_point(@exit)
  end
